...
const _routes = [
  ...
  },
  {
    ...
    component: () => import("./_nuxt/_id_-BdfLVYfn.js")
  },
  {
    name: "gifting-id",
    path: "/gifting/:id()",
  ...
  },
  {
    ...
    component: () => import("./_nuxt/staff-program-CYRelmXj.js")
  },
  {
    name: "support",
    path: "/support",
  ...
  },
  {
    ...
    component: () => import("./_nuxt/index-CjVazIPP.js")
  },
  {
    name: "investments-proposals",
    path: "/investments/proposals",
    component: () => import("./_nuxt/index-0aClSJr2.js")
  }
];
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/2emZd1xM"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/2emZd1xM"}/${locale}/messages.json`));
...
const layouts = {
  ...
  dashboard: defineAsyncComponent(() => import("./_nuxt/dashboard-BDFH2JIZ.js").then((m) => m.default || m)),
