...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.BjCObGYQ.mjs').then(interopDefault),
  "components/ToastContainer.vue": () => import('./_nuxt/ToastContainer-styles.DsJbTbre.mjs').then(interopDefault),
  "components/ToastContainer.vue?vue&type=style&index=0&scoped=635a3b41&lang.css": () => import('./_nuxt/ToastContainer-styles.DsJbTbre.mjs').then(interopDefault),
  ...
  "layouts/dashboard.vue": () => import('./_nuxt/dashboard-styles.Bri94u9-.mjs').then(interopDefault),
  "layouts/dashboard.vue?vue&type=style&index=0&scoped=67c37feb&lang.css": () => import('./_nuxt/dashboard-styles.Bri94u9-.mjs').then(interopDefault)
}