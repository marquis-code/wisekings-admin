...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.BjCObGYQ.mjs').then(interopDefault),
  "components/ToastContainer.vue": () => import('./ToastContainer-styles.DsJbTbre.mjs').then(interopDefault),
  "components/ToastContainer.vue?vue&type=style&index=0&scoped=635a3b41&lang.css": () => import('./ToastContainer-styles.DsJbTbre.mjs').then(interopDefault),
  ...
  "layouts/dashboard.vue": () => import('./dashboard-styles.Bri94u9-.mjs').then(interopDefault),
  "layouts/dashboard.vue?vue&type=style&index=0&scoped=67c37feb&lang.css": () => import('./dashboard-styles.Bri94u9-.mjs').then(interopDefault)
};
